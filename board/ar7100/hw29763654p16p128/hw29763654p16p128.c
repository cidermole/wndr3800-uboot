...
int checkboard (void)
{
    ...
    printf("DNI HW ID: 29763654 flash 16MB RAM 128MB (ar7100) U-boot dni25 V0.1\n");
    return 0;
}
...
int board_match_image_hw_id (ulong fw_image_addr)
{
    ...
    /* For WNDR3700v2 firmware version <= V1.0.0.6, do not support HW ID yet.
     * We do not support HW ID in these old firmware image.
     * It is a special case only for WNDR3700v2 V1.0.0.0, V1.0.0.2, V1.0.0.4,
     * and V1.0.0.6
     */
    ...
    if (strcmp(image_model_id ,"WNDR3700v2") == 0) {
	printf("WNDR3700v2 Firmware, check special case\n");
	if (strcmp(image_version, "V1.0.0.0") == 0) {
	    printf("WNDR3700v2 V1.0.0.0 Firmware, Ignore HW ID checking\n\n");
	    return 1;
	} else if (strcmp(image_version, "V1.0.0.2") == 0) {
	    printf("WNDR3700v2 V1.0.0.2 Firmware, Ignore HW ID checking\n\n");
	    return 1;
	} else if (strcmp(image_version, "V1.0.0.4") == 0) {
	    printf("WNDR3700v2 V1.0.0.4 Firmware, Ignore HW ID checking\n\n");
	    return 1;
	} else if (strcmp(image_version, "V1.0.0.6") == 0) {
	    printf("WNDR3700v2 V1.0.0.6 Firmware, Ignore HW ID checking\n\n");
	    return 1;
	} else {
	    printf("Firmware version > V1.0.0.6, checking HW ID\n\n");
	}
    }
